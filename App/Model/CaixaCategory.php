...
class CaixaCategory{
    ...
    public function InserirCategoria(){
        ...
        $comando = "INSERT INTO tb_caixa_categoria (nome) values(:nome)";
    ...
    public function DevolverCategorias(){
        $conexao = Conexao::retornaConexao();
        $comando = "SELECT * FROM tb_caixa_categoria";
        $sql = new PDOStatement;
        $sql = $conexao->prepare($comando);
        $sql->execute();
    ...
    public function ExcluirCategoria($idCategory){
        $conexao = Conexao::retornaConexao();
        $comando = "DELETE FROM tb_caixa_categoria WHERE id_categoria = :id_categoria";
        $sql = new PDOStatement;
        $sql = $conexao->prepare($comando);
    ...
    public function TraduzirCategoria($id){
        $conexao = Conexao::retornaConexao();
        $comando = "SELECT nome FROM tb_caixa_categoria WHERE id_categoria = :id_categoria";
        $sql = new PDOStatement;
        $sql = $conexao->prepare($comando);
